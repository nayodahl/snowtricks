 ...
 */
final class Version20200820092937 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trick ADD CONSTRAINT FK_D8F0A91E306FF23 FOREIGN KEY (featured_id) REFERENCES image (id)');
